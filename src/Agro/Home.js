            ...
            <div className="w3layouts-banner-top">
              <div className="container">
                <div className="agileits-banner-info">
                  ...
                  <p>
                    AS farm uses IoT technology to monitor and manage farming
        ...
        <div className="container">
          <div className="row justify-content-between">
            <div className="col-md-5 w3l-welcome-left">
              <h2>
                Welcome <span>to AS farm</span>
              </h2>
              <p>
                AS farm uses IoT technology to monitor and manage farming activities
        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-sm-6">
            <div className="w3-agileits-services-grid text-center">
              ...
              <p>
                AS farm collects real-time data from IoT sensors monitoring soil
          ...
          <div className="col-lg-6 col-sm-6">
            <div className="w3-agileits-services-grid text-center">
              ...
              <p>
                AS farm offers an intuitive web and mobile app interface, making
